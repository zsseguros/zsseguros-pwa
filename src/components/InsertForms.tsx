...
export const ClientInserForm = (props: any) => {
  ...
  return (
    <div
      className="col-xs-10 col-xs-push-2 col-md-6 col-md-push-4 panel panel-primary rounded"
      style={{ padding: "10px" }}
    >
...
export const ContactInsertForm = (props: any) => {
  return(
    <div
      className="col-xs-10 col-xs-push-2 col-md-6 col-md-push-4 panel panel-primary"
      style={{ padding: "10px" }}
    >
